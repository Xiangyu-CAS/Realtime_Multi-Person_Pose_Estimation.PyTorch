...
def main():
    ...
    img_dir = '/home/xiangyuzhu/workspace/data/coco/images/val2014/'
    annFile = '/home/xiangyuzhu/workspace/data/coco/annotations/person_keypoints_minival2014.json'
    num_imgs = 50 #
    ...
    for i in range(num_imgs):
        ...
        img_anns = cocoGt.loadAnns(image_id)
