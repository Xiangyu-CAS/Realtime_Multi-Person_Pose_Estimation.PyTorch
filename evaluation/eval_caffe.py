import os
import sys
sys.path.append('/root/deep_learning/caffe/caffe-1.0/python/')
import caffe
import numpy as np
import cv2
...
COCO_Oder = [1, 0, 7, 9, 11, 6, 8, 10, 13, 15, 17, 12, 14, 16, 3, 2, 5, 4]
'''
...
def apply_model(oriImg, net, multiplier):
    ...
    for m in range(len(multiplier)):
        ...
        imageToTest_padded, pad = padRightDownCorner(imageToTest, stride, 128)
...
def main():
    deployFile = '/home/xiangyu/data/pretrain/COCO/pose_deploy.prototxt'
    caffemodel = '/home/xiangyu/data/pretrain/COCO/pose_iter_440000.caffemodel'
    ...
    for i in range(num_imgs):
        ...
        # apply model
        candidate, subset,canvas = apply_model(oriImg, net, multiplier)
