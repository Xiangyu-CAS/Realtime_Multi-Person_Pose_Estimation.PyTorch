...
def parse():
    ...
    parser.add_argument('--train_dir', nargs='+', type=str,
                        ...
                        default=['/home/xiangyu/data/samsung_pose_data_train/img_list/train2014.txt',
                                  '/home/xiangyu/data/samsung_pose_data_train/mask_list/train2014.txt',
                                  '/home/xiangyu/data/samsung_pose_data_train/json/train2014.json']
                        )
